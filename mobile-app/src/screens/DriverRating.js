...
export default function DriverRating(props) {
  ...
  return (
    <>
      {/* <ScrollView> */}
        <Receipt starCount={starCount} submitNow={submitNow} booking={booking} moment={moment} settings={settings} onStarRatingPress={onStarRatingPress} />
          ...
          <View style={styles.tripMainView}>
            ...
            <View style={styles.ratingViewStyle}>
              <StarRating
                ...
                rating={starCount}
                selectedStar={(rating) => {
                  onStarRatingPress(rating), console.log("Rating", rating);
                }}
